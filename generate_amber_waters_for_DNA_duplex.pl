#! /usr/bin/perl -w 
#
# This script generates explicit water moelcules (one per nucleotide)
# around a double stranded DNA.
#
#
# usage:
...
$H2O_bend = 104.52/180.0*PI;
$cos_theta = cos($H2O_bend);
$sin_theta = sin($H2O_bend);
...
#FROM HELIX 
          ...
          $Oatom = '         O';
          substr($entry_D00,70,10) = sprintf("%4s",$Oatom);
          print "$entry_D00\n";
          ...
          substr($entry_D00,6,5) = sprintf("%5s",$atomSeq);
          $xH1 = $xD00 + $dx_H1;
          substr($entry_D00,30,8) = sprintf("%8.4g",$xH1);
          $Hatom = '         H';
          substr($entry_D00,70,10) = sprintf("%4s",$Hatom);
          print "$entry_D00\n";
          ...
          $xH2 = $xD00 + $dx_H2;
          $yH2 = $yD00 + $dy_H2;
          substr($entry_D00,30,8) = sprintf("%8.4g",$xH2);
          substr($entry_D00,38,8) = sprintf("%8.4g",$yH2);
          $Hatom = '         H';
          substr($entry_D00,70,10) = sprintf("%4s",$Hatom);
          print "$entry_D00\n";
